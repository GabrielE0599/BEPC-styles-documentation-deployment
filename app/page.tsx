...
import { FileOutlined, MailOutlined, StarOutlined, SearchOutlined, ReloadOutlined, PoweroffOutlined, HeartOutlined,
...
const code1 = `function greet() {
return "Hello, World!";
}`;

const code2 = `@import url('https://fonts.googleapis.com/css2?family=Poppins:wght@700&display=swap');`;

const code3 = `@import url('https://fonts.googleapis.com/css2?family=Figtree&display=swap');`;

const code4 = `https://heroicons.com/`;

const code5 = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
</svg>`;

const code6 = `<h1 className='table-name my-1 p-3'>
                ...
                <TabsContent value="music" className="border-none p-0 outline-none">
                  ...
                  <div className="menu-colors flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p>Our carefully curated color palette reflects the essence of our brand, symbolizing innovation,
                        reliability, and creativity. </p>
                      <p>From primary tones that lay the foundation of our identity to secondary shades that add depth,
                  ...
                  <div className="menu-typography flex items-center justify-between">
                    <div className="space-y-4">
                      ...
                      <p>At BEPC Inc., every design decision is rooted in a purposeful blend of aesthetics and
                        functionality.</p>
                      <p>The careful selection of typefaces plays a pivotal role in creating a consistent and impactful
                        brand identity.</p>
                  ...
                  <p>Its versatility ensures that our content remains engaging, whether in digital interfaces or printed
                    materials.</p>
                  <br></br>
                  <CodeSnippet code={code2} language="css" />
                  ...
                  <p>Figtree, our secondary typeface, adds a touch of artistic flair and approachable elegance to our
                    brand.</p>
                  <p>This script font draws inspiration from hand-lettered calligraphy, conveying a sense of human touch
                    and creativity.</p>
                  ...
                  <br></br>
                  <CodeSnippet code={code3} language="css" />
                  ...
                  <div className="menu-icons flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <h5>Hero icons</h5>
                      <p className="text-sm text-muted-foreground"></p>
                      <p>the decision to opt for the Hero Icons library from Tailwind for BEPC Inc. systems was based on its visually appealing designs,
                         seamless integration with existing workflows, adaptability for modern development practices, and open-source nature that encourages customization.
                          This choice is poised to enhance the overall aesthetic, functionality, and user experience of BEPC Inc systems while aligning with their development philosophy.</p>
                      <br></br>
                    </div>
                  </div>
                  ...
                  <CodeSnippet code={code4} language="bash" />
                  ...
                  <CodeSnippet code={code5} language="bash" />
                  ...
                  <p className='my-2'>And this is the basic structure to create a table like this with HTML and CSS.
                  Depending on the requirements of the project, it is possible to modify it.</p>
                  <br></br>
                  <h5>HTML</h5>
                  <CodeSnippet code={code6} language="html" />
                  <br></br>
                  <h5>CSS</h5>
